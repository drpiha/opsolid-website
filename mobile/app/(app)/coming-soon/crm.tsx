// Verso v2 — Coming Soon: CRM Pipeline stub screen.
// No real waitlist API yet. M7+: wire to real waitlist endpoint.

import { useState } from 'react';
import { View, Text } from 'react-native';
import { useRouter } from 'expo-router';
import { ChevronLeft, Sparkles, Workflow } from 'lucide-react-native';
...
export default function CrmComingSoon() {
      ...
      <View style={{ padding: 24, gap: 24 }}>
        <Card variant="glow" padded={24}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 12 }}>
            <Workflow size={28} color={theme.text} />
