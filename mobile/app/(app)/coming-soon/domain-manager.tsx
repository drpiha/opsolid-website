// Verso v2 — Coming Soon: Custom Domain Manager stub screen.
// Available on web today — mobile UX coming.
// No real waitlist API yet. M7+: wire to real waitlist endpoint.

import { useState } from 'react';
import { View, Text } from 'react-native';
import { useRouter } from 'expo-router';
import { ChevronLeft, Sparkles, Globe } from 'lucide-react-native';
...
export default function DomainManagerComingSoon() {
