...
export const content = {
  ...
  products: {
    ...
    digitalCard: {
      hero: {
        eyebrow: "[ VERSO BY OPSOLID ]   PREMIUM DIGITAL BUSINESS CARDS",
        title: [
          "Verso.",
        ...
        paragraph:
          "Verso is a hand-designed one-page digital profile we build for you. Share it as a link or QR code. 20+ industry templates as starting points. German hosting, GDPR-native — no subscription traps.",
        primaryCta: "Start my Verso",
        secondaryCta: "See 20 live templates",
        tags: "VERSO · LINK · QR CODE · CUSTOM DESIGN · 48H DELIVERY · GERMAN HOSTING",
        cardLabels: {
          name: "Alex Weber",
  ...
  v2: {
    ...
    productsHub: {
      meta: {
        title: "Products — Voice, Verso, Chat, WhatsApp, Booking, Email, Lead, Custom, Kutasia | OpSolid",
        description: "Nine products from one studio: AI agents for phone, chat, WhatsApp, email and lead qualification, premium digital business cards (Verso), custom workflow automation, and Kutasia for hospitality. Every product transparent-priced and EU-hosted.",
      },
      hero: {
        eyebrow: "[ PRODUCTS · 2026 ]",
        title: { pre: "Nine products, ", italic: "one studio", post: "" },
        lead: "Every product on this page is built and run by the same team. Voice, chat, and WhatsApp agents share an integration spine. Verso, our premium digital business card, ships in 48 hours. Custom Automation handles the workflows the rest can't reach. Kutasia is the hospitality-focused application of all of this. Pick the surface, we'll handle the rest.",
      ...
      featured: {
        ...
        items: [
          ...
          },
          {
            ...
            tagline: "Premium digital business card · NFC + QR + custom domain.",
            body: "Hand-designed, German-hosted digital profiles delivered in 48 hours. 20+ industry templates. Integrates with HubSpot. Replace paper cards without becoming Linktree.",
            href: "/products/digital-card",
            startingAt: "from €4/user/mo + €29 setup",
            badge: "Live",
          },
        ],
      },
      grid: {
        ...
        items: [
          ...
          { id: "kutasia", name: "Kutasia", tagline: "Multi-tenant SaaS for hospitality operators.", startingAt: "from €39/seat/mo", href: "/products/kutasia", category: "VERTICAL" },
        ],
      },
      bottomCta: {
    ...
    pricing: {
      meta: {
        ...
        description: "Transparent EUR pricing for OpSolid's nine products: Voice Agent, Verso, Chatbot, WhatsApp, Booking, Email, Lead Qualifier, Custom Automation, and Kutasia.",
      },
      hero: {
      ...
      products: [
        ...
        },
        {
          id: "verso",
          name: "Verso by OpSolid",
          tagline: "Premium digital business cards — link, QR, NFC, German-hosted.",
          href: "/products/digital-card",
          tiers: [
            {
              name: "Standard",
              setup: "€29 (NFC card)",
              monthly: "€4/user/mo",
              included: ["1 profile", "QR + NFC + link", "vCard export", "Basic analytics", "20+ industry templates"],
              overage: "",
              forWhom: "Solo / consultant / freelancer",
              isHighlighted: false,
            },
            {
              name: "Professional",
              setup: "€49/user (NFC + custom design)",
              monthly: "€7/user/mo",
              included: ["Custom domain", "Lead capture form", "CRM webhook (HubSpot, Pipedrive)", "Team branding kit", "Advanced analytics"],
              overage: "",
              forWhom: "5–50 person sales / agency teams",
              isHighlighted: true,
            },
            {
              name: "Enterprise",
              setup: "€99/user (premium card + onboarding)",
              monthly: "€5/user/mo (50+ seats)",
              included: ["SSO / SAML", "AD / SCIM provisioning", "Audit log", "White-label", "DPA on request"],
              overage: "",
              forWhom: "50+ seat orgs, regulated employers",
              isHighlighted: false,
            },
          ],
        },
        ...
        },
        {
          id: "kutasia",
          name: "Kutasia",
          tagline: "Multi-tenant SaaS for hospitality — reservations, memberships, guest memory.",
          href: "/products/kutasia",
          tiers: [
            {
              name: "Standard",
              setup: "€1,500",
              monthly: "€39/seat/mo (5 min)",
              included: ["1 sector template", "5 workflows", "Email + WhatsApp channels", "Cal.com integration", "Basic analytics"],
              overage: "",
              forWhom: "Single-location operator",
              isHighlighted: false,
            },
            {
              name: "Professional",
              setup: "€3,000",
              monthly: "€69/seat/mo (10 min)",
              included: ["All sector templates", "Custom workflows", "CRM sync", "Advanced analytics", "Multi-staff roles"],
              overage: "",
              forWhom: "Multi-staff sector business",
              isHighlighted: true,
            },
            {
              name: "Enterprise",
              setup: "—",
              monthly: "from €149/seat/mo (talk to us)",
              included: ["White-label", "Multi-tenant management", "SLA", "Dedicated CSM", "Custom integrations"],
              overage: "",
              forWhom: "Franchise / multi-brand operations",
              isHighlighted: false,
            },
          ],
        },
      ...
      bundles: {
        ...
        items: [
          ...
          { rule: "Verso teams (50+ seats) bundled with any agent", benefit: "Verso seat price drops to €4/user/mo" },
