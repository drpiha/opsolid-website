...
export const content = {
  ...
  products: {
    ...
    digitalCard: {
      ...
      order: {
        ...
        form: {
          ...
          designNotes: "Design notes (optional)",
          designNotesPh:
            "Anything special? Fonts, logos, references …",
          billingSection: "Billing mode",
          billingOneTime: "One-time",
          oneTimeFooter: "Pay once, card hosted for life.",
          billingSubscription: "Yearly subscription",
          subscriptionFooter: "Includes updates + revisions.",
          totalLabel: "Total",
    ...
    whatsappAgent: {
      ...
      faq: {
        label: "FAQ",
        heading: "Honest answers about an opaque channel.",
        items: [
          {
    ...
    emailAgent: {
      ...
      faq: {
        label: "FAQ",
        heading: "Honest answers about a spammy-by-default channel.",
        items: [
          {
