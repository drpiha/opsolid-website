    ...
    pricing: {
      ...
      products: [
        ...
        },
        {
          id: "kutasia",
          name: "Kutasia",
          tagline: "Hospitality için multi-tenant SaaS — rezervasyon, üyelik, guest memory.",
          href: "/products/kutasia",
          tiers: [
            {
              name: "Standard",
              setup: "€1.500",
              monthly: "€39/koltuk/ay (min 5)",
              included: ["1 sektör şablonu", "5 workflow", "E-mail + WhatsApp kanalları", "Cal.com entegrasyonu", "Temel analitik"],
              overage: "",
              forWhom: "Tek lokasyon operatörü",
              isHighlighted: false,
            },
            {
              name: "Professional",
              setup: "€3.000",
              monthly: "€69/koltuk/ay (min 10)",
              included: ["Tüm sektör şablonları", "Custom workflow", "CRM senk.", "Gelişmiş analitik", "Multi-staff rolleri"],
              overage: "",
              forWhom: "Multi-staff sektör işletmesi",
              isHighlighted: true,
            },
            {
              name: "Enterprise",
              setup: "—",
              monthly: "€149/koltuk/ay'dan (bizimle konuşun)",
              included: ["White-label", "Multi-tenant yönetim", "SLA", "Adanmış CSM", "Custom entegrasyon"],
              overage: "",
              forWhom: "Franchise / multi-brand operasyonları",
              isHighlighted: false,
            },
          ],
        },
