...
import { InterneToolsV2 } from "@/components/v2/interne-tools/InterneToolsV2";
...
const SLUG = "interne-tools";

const META_BY_LOCALE = {
  de: de.v2.services.interneTools.meta,
  en: en.v2.services.interneTools.meta,
  tr: tr.v2.services.interneTools.meta,
} as const;
...
export default function Page({
  ...
  if (isPreviewV2(searchParams)) {
    return (
      <V2Shell>
        <ServiceJsonLd serviceKey="interneTools" />
        <InterneToolsV2 />
      </V2Shell>
    );
  }
  return (
    <>
      <ServiceJsonLd serviceKey="interneTools" />
      <ServicePage serviceKey="interneTools" />
    </>
  );
}
