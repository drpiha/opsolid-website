...
const META = {
  en: en.v2.productPages.pages.bookingAgent.meta,
  de: de.v2.productPages.pages.bookingAgent.meta,
  tr: tr.v2.productPages.pages.bookingAgent.meta,
} as const;
...
export default function Page() {
  return <ProductStubPage pageId="bookingAgent" pricingProductId="booking-agent" />;
}
