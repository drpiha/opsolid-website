...
const META = {
  en: en.v2.productPages.pages.whatsappAgent.meta,
  de: de.v2.productPages.pages.whatsappAgent.meta,
  tr: tr.v2.productPages.pages.whatsappAgent.meta,
} as const;
...
export default function Page() {
  return <ProductStubPage pageId="whatsappAgent" pricingProductId="whatsapp-agent" />;
}
