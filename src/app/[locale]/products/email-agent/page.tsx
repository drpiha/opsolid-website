...
const META = {
  en: en.v2.productPages.pages.emailAgent.meta,
  de: de.v2.productPages.pages.emailAgent.meta,
  tr: tr.v2.productPages.pages.emailAgent.meta,
} as const;
...
export default function Page() {
  return <ProductStubPage pageId="emailAgent" pricingProductId="email-agent" />;
}
