...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: SITE_CONFIG.description,
    // Default share image. Set explicitly (not just via the opengraph-image file
    // convention) so it survives the per-page openGraph overrides that would
    // otherwise leave pages with no og:image. Resolves against metadataBase.
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
