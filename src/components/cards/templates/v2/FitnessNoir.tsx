...
const COPY: Record<"de" | "en" | "tr" | "es" | "it" | "fr" | "ar", Copy> = {
  ...
  es: {
    ...
    resultsH: "Antes / Después",
    before: "Antes",
    after: "Después",
    ctaPanelTitle: "Iniciar el programa",
    ctaPanelSub: "La primera consulta es gratis. Escríbenos.",
    ctaPrimary: "Llamar ahora",
    ctaSecondary: "WhatsApp",
    contactTag: "— 03 / Contacto",
    contactH: "Conexión",
  ...
  it: {
    ...
    before: "Prima",
    after: "Dopo",
    ctaPanelTitle: "Avvia il programma",
    ctaPanelSub: "La prima consulenza è gratuita. Scrivici.",
    ctaPrimary: "Chiama ora",
    ctaSecondary: "WhatsApp",
    contactTag: "— 03 / Contatto",
    contactH: "Connessione",
    bookBtn: "Inizia ora",
  ...
  fr: {
    ...
    resultsH: "Avant / Après",
    before: "Avant",
    after: "Après",
    ctaPanelTitle: "Démarrer le programme",
    ctaPanelSub: "La première consultation est gratuite. Écrivez-nous.",
  ...
  ar: {
    ...
    before: "قبل",
    after: "بعد",
    ctaPanelTitle: "ابدأ البرنامج",
    ctaPanelSub: "الاستشارة الأولى مجانية. راسلنا.",
