...
const COPY: Record<"de" | "en" | "tr" | "es" | "it" | "fr" | "ar", Copy> = {
  ...
  es: {
    ...
    issueMark: "Edición n.º 04 · Vivir",
    headlineLead: "Habitaciones",
    headlineAccent: "con alma",
    headlineTail: "— tranquilo,\nvivido, honesto.",
    callBtn: "Llamar",
    whatsappBtn: "WhatsApp",
    emailBtn: "Correo",
    philosophyH: "Voz",
    ...
    featuredBadge: "En curso",
    servicesH: "Servicios",
    processH: "Proceso",
    step1: "Recorrido y briefing",
    step2: "Concepto y materiales",
    step3: "Construir y entregar",
  ...
  it: {
    ...
    issueMark: "Numero 04 · Vivere",
    headlineLead: "Camere",
    headlineAccent: "con anima",
    headlineTail: "— tranquillo,\nvissuto, onesto.",
    callBtn: "Chiama",
    whatsappBtn: "WhatsApp",
    emailBtn: "Email",
    philosophyH: "Voce",
    philosophyLabel: "Editoriale",
    featuredH: "Progetto in corso",
    featuredLabel: "In evidenza",
    featuredBadge: "In corso",
    servicesH: "Servizi",
    processH: "Processo",
    step1: "Walk-through e brief",
    step2: "Concetto e materiali",
    step3: "Costruzione e consegna",
  ...
  fr: {
    ...
    issueMark: "Numéro 04 · Vivre",
    headlineLead: "Chambres",
    headlineAccent: "avec âme",
    headlineTail: "— calme,\nvécu, honnête.",
    callBtn: "Appeler",
    whatsappBtn: "WhatsApp",
    emailBtn: "E-mail",
    philosophyH: "Voix",
    philosophyLabel: "Éditorial",
    featuredH: "Projet en cours",
    featuredLabel: "À la une",
    featuredBadge: "En cours",
    servicesH: "Services",
    processH: "Processus",
    step1: "Visite et brief",
    step2: "Concept et matériaux",
    step3: "Construction et livraison",
  ...
  ar: {
    ...
    processH: "العملية",
    step1: "جولة وموجز",
    step2: "المفهوم والمواد",
    step3: "البناء والتسليم",
    cta: "احجز استشارة",
