...
export const COPY: Record<"de" | "en" | "tr" | "es" | "it" | "fr" | "ar", RepCopy> = {
  de: {
    about: "Über mich",
  ...
  es: {
    ...
    about: "Acerca de",
    specialisation: "Especializaciones",
    serviceRange: "Gama de servicios",
    contact: "Contacto",
    contactReach: "Contacta",
    ref: "Voz del cliente",
  ...
  it: {
    ...
    about: "Chi siamo",
    specialisation: "Specializzazioni",
    serviceRange: "Gamma di servizi",
    contact: "Contatto",
    contactReach: "Contattaci",
    ref: "Voce del cliente",
  ...
  fr: {
    ...
    serviceRange: "Gamme de services",
    contact: "Contact",
    contactReach: "Nous contacter",
    ref: "Voix du client",
