...
export function HomeJsonLd() {
  ...
  const professionalService = {
    ...
    founder: {
      ...
      name: "Hasan Dönmez",
      jobTitle: "Founder",
      url: "https://www.linkedin.com/in/hasanhd/",
      sameAs: ["https://www.linkedin.com/in/hasanhd/"],
    },
    disambiguatingDescription:
      "Independent AI & automation consultancy at opsolid.de. Not affiliated with the TopSolid CAD/CAM software.",
    ...
    sameAs: [
      "https://www.linkedin.com/in/hasanhd/",
    ],
