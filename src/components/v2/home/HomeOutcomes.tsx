...
const COPY = {
  de: {
    ...
    finalHeadline: { pre: "30 Minuten ", em: "ehrliches", post: " Hinhören" },
    finalLead: "Ohne Pitch-Deck. Wir hören zu, sagen Ihnen direkt, ob es sich rechnet, und schicken danach eine schriftliche Einschätzung.",
  ...
  en: {
    ...
    finalHeadline: { pre: "30 minutes of ", em: "honest", post: " listening" },
    finalLead: "No pitch deck. We listen, tell you whether it pays back, then send a written assessment afterwards.",
  ...
  tr: {
    ...
    finalHeadline: { pre: "30 dakika ", em: "dürüst", post: " dinleme" },
    finalLead: "Pitch deck yok. Dinliyoruz, kendini ödüyor mu doğrudan söylüyoruz, sonra yazılı değerlendirme yolluyoruz.",
