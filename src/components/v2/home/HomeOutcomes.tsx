...
const COPY = {
  de: {
    ...
    finalEyebrow: "Erstgespräch",
    finalHeadline: { pre: "30 Minuten — ", em: "wir hören zu", post: ", dann lesen Sie" },
    finalLead: "Kein Pitch-Deck. Wir hören Ihrem Vorgang zu, sagen Ihnen, ob es sich rechnet, und schicken im Nachgang eine schriftliche Einschätzung.",
    finalCta: "Termin buchen",
  ...
  en: {
    ...
    finalEyebrow: "Discovery call",
    finalHeadline: { pre: "30 minutes — ", em: "we listen", post: ", then you read" },
    finalLead: "No pitch deck. We listen to your operation, tell you whether it pays back, then send a written assessment.",
  ...
  tr: {
    ...
    finalEyebrow: "Ön görüşme",
    finalHeadline: { pre: "30 dakika — ", em: "biz dinleriz", post: ", siz okursunuz" },
    finalLead: "Pitch deck yok. Operasyonunuzu dinleriz, kendini ödüyor mu söyleriz, sonra yazılı değerlendirme yollarız.",
